-- Insert sample tax content for RAG system
-- This will add comprehensive answers to the popular questions

-- Clear any existing sample content first
DELETE FROM documents WHERE metadata->>'source' = 'sample';

-- Insert corporate tax rates content
INSERT INTO documents (content, metadata, embedding) VALUES (
  'Canadian Corporate Tax Rates 2025-2026:
...
- Provincial small business rates vary by province',
  '{"source": "sample", "fileName": "canadian-corporate-tax-rates-2025-2026.pdf", "section": "Corporate Tax Rates", "chunkIndex": 0, "totalChunks": 1, "fileType": "pdf", "uploadedAt": "2025-07-29T18:30:00.000Z"}',
  '[]' -- Placeholder embedding, will be generated by the system
);

-- Insert depreciation rules content
INSERT INTO documents (content, metadata, embedding) VALUES (
  'Depreciation Rules for Business Equipment and Property:
...
- Second year CCA: ($10,000 - $2,750) × 55% = $3,987.50',
  '{"source": "sample", "fileName": "depreciation-rules-guide.pdf", "section": "CCA Classes and Rules", "chunkIndex": 0, "totalChunks": 1, "fileType": "pdf", "uploadedAt": "2025-07-29T18:30:00.000Z"}',
  '[]'
);

-- Insert AI tax research best practices content
INSERT INTO documents (content, metadata, embedding) VALUES (
  'AI Tax Research Best Practices:
...
- Maintain human oversight of critical decisions',
  '{"source": "sample", "fileName": "ai-tax-research-best-practices.pdf", "section": "Research Best Practices", "chunkIndex": 0, "totalChunks": 1, "fileType": "pdf", "uploadedAt": "2025-07-29T18:30:00.000Z"}',
  '[]'
);

-- Insert Section 199A QBI deduction content
INSERT INTO documents (content, metadata, embedding) VALUES (
...
- Requires careful planning to maximize benefit',
  '{"source": "sample", "fileName": "section-199a-qbi-deduction.pdf", "section": "QBI Deduction Rules", "chunkIndex": 0, "totalChunks": 1, "fileType": "pdf", "uploadedAt": "2025-07-29T18:30:00.000Z"}',
  '[]'
);

-- Insert international tax regulations content
INSERT INTO documents (content, metadata, embedding) VALUES (
  'Latest Changes to International Tax Regulations (GILTI):
...
- Enhanced documentation and reporting requirements',
  '{"source": "sample", "fileName": "international-tax-regulations-2024.pdf", "section": "GILTI and International Tax", "chunkIndex": 0, "totalChunks": 1, "fileType": "pdf", "uploadedAt": "2025-07-29T18:30:00.000Z"}',
  '[]'
);

-- Insert personal tax rates content
INSERT INTO documents (content, metadata, embedding) VALUES (
  'Personal Income Tax Rates in Canada (2025)
...
These rates are indexed to inflation and may be adjusted annually.',
  '{"source": "sample", "fileName": "canadian-personal-tax-rates-2025.pdf", "section": "Personal Tax Rates", "chunkIndex": 0, "totalChunks": 1, "fileType": "pdf", "uploadedAt": "2025-07-29T18:30:00.000Z"}',
  '[]'
);

-- Insert tax planning strategies content
INSERT INTO documents (content, metadata, embedding) VALUES (
...
These strategies should be implemented in consultation with qualified tax professionals.',
  '{"source": "sample", "fileName": "tax-planning-strategies-2025.pdf", "section": "Tax Planning", "chunkIndex": 0, "totalChunks": 1, "fileType": "pdf", "uploadedAt": "2025-07-29T18:30:00.000Z"}',
  '[]'
); 